...
#pragma endregion
	void Scene_W4_Bunny::Initialize()
	{
		...
		pMesh = AddTriangleMesh(TriangleCullMode::FrontFaceCulling, matLambert_White);
	...
	void Scene_W4_Triangle::Initialize()
	{
		...
		const auto pMesh = AddTriangleMesh(TriangleCullMode::BackFaceCulling, matLambert_White);
		pMesh->positions = {
			{-.75f,-1.f,.0f},  //V0
			{-.75f,1.f, .0f},  //V2
			{.75f,1.f,1.f},    //V3
		...
		pMesh->UpdateTransforms();
		m_TriangleMeshGeometries.push_back(*pMesh);
